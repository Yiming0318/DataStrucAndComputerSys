...
int pushLeft(LinkedListPtr list, int value) {
    addLeft(list, value);
}

int pushRight(LinkedListPtr list, int value) {
    addRight(list, value);
}
...
int popRight(LinkedListPtr list) {
    // since both functions return values
    // store these two value in an int array
    if (list == NULL) {
        return;
    }
    int value;
    int success;
    value = peekRight(list);
    success = removeRight(list);
    int res[2] = {value, success};
    return res[0];
}
...
int main() {
    ...
    printf("pushLeft node 1 to the empty deque \n");
    pushLeft(list, 1);
    PrintLinkedList(list);
    printf("\n");
    printf("pushLeft node 0 to the deque \n");
    pushLeft(list, 0);
    PrintLinkedList(list);
    printf("\n");
    printf("pushRight node 2 to the deque \n");
    addRight(list, 2);
    PrintLinkedList(list);
    printf("\n");
    printf("Peek right in the deque \n");
    printf("The rightmost value is %d \n", peekRight(list));
    PrintLinkedList(list);
    printf("\n");
    printf("Peek left in the deque \n");
    printf("The leftmost value is %d \n", peekLeft(list));
    PrintLinkedList(list);
    printf("\n");
    printf("Pop right in the deque \n");
    printf("The rightmost value is %d \n", popRight(list));
    PrintLinkedList(list);
    printf("\n");
    printf("Pop left in the deque \n");
    printf("The leftmost value is %d \n", popLeft(list));
    PrintLinkedList(list);
    printf("\n");
